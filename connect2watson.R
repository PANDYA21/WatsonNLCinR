...
username = "840e88ba-0418-404c-ba63-6b7ce82f457b" # from Bluemix Service Credentials
password = "CQ2RHUddiEtB"
...
dialog_id <- head(data$dialog_id,1) #tail(data$dialog_id,1) ### LETS TAKE THE LATEST LAST ONE IF MORE THAN ONE DIALOG_ID
dialog_id <- paste(dialog_id) # gets rid of levels
dialog_id

# dialog_id <- "e055e0fb-1fdb-48f3-bb16-b0242491d5ca"
