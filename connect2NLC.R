...
status <- "2374f9x68-nlc-1308" # "2373f5x67-nlc-1380" # "950DCB-nlc-###" 
...
classifier = "2374f9x68-nlc-1308" # "2373f5x67-nlc-1380" # "950DCB-nlc-###" 
...
query = "I am bhaumik"
watson.nlc.processtextreturnclass(classifier,query) # sadly wrong

query = "My name is bhaumk"
watson.nlc.processtextreturnclass(classifier,query) # perfact!
...
query = "I play everynight"
watson.nlc.processtextreturnclass(classifier,query) # didnt get that

query = "I dont play often"
watson.nlc.processtextreturnclass(classifier,query)

query = "I dont play tennis often"
watson.nlc.processtextreturnclass(classifier,query)

query = "I play smash"
watson.nlc.processtextreturnclass(classifier,query)

query = "I play topspin"
watson.nlc.processtextreturnclass(classifier,query)

query = "I play slice"
watson.nlc.processtextreturnclass(classifier,query)

query = "I am a beginner"
watson.nlc.processtextreturnclass(classifier,query)

query = "I am a newbie"
watson.nlc.processtextreturnclass(classifier,query)

query = "I began to play tennis a long ago"
watson.nlc.processtextreturnclass(classifier,query)

query = "I began to play tennis from yesterday"
watson.nlc.processtextreturnclass(classifier,query)
